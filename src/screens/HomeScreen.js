...
import { UpdateMoneyCard } from "../function/updateMoneyCart";

const HomeScreen = ({ navigation }) => {
  
  // comes from  dataSlice = createSlice({name: 'data', data its the name of dataslice
  ...
  // update all data state in store
  useEffect(() => {
  ...
  // update cart to firebase when cart change, when money changes
  useEffect(() => {
...
// update or add item to history collection
  useEffect(() => {
  ...
  // update user email, update card with basic options card
  useEffect(() => {
  ...
  /*** handle the input in search component */
