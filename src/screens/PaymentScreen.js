  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.paymentsContainer}>
        ...
        <Payment2 image={require('../assets/app_images/gpay.png')} name='Google Pay' onPress={() => handlePress('GooglePay')} isSelected={payment === 'GooglePay'} />
        <Payment2 image={require('../assets/app_images/applepay.png')} name='Apple Pay' onPress={() => handlePress('ApplePay')} isSelected={payment === 'ApplePay'} />
        <Payment2 image={require('../assets/app_images/amazonpay.png')} name='Amazone' onPress={() => handlePress('Amazon')} isSelected={payment === 'Amazon'} />
      </View>
